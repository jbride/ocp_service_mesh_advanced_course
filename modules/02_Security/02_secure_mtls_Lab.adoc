...
* Create a configuration file for openSSL that substitutes the previously set environment variables: _$ERDEMO_USER_ and _$SUBDOMAIN_BASE_:
+
----
...
+
----
$ oc rollout latest deploy istio-ingressgateway -n $RHSM_CONTROL_PLANE_NS
----
...
. Create a file called `wildcard-gateway.yml` with the following contents:
+
----
---
...
spec:
  ...
  - port:
    ...
    hosts:
    - \"*.$ERDEMO_USER.apps.$SUBDOMAIN_BASE\"" > wildcard-gateway.yml
----
