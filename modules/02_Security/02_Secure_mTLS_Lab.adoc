...
== Set Authorization Policy for Services usin Istio RBAC
...
[NOTE]
====
If you have done the previous section ofthe lab, delete the `ServiceMeshRbacConfig`, `ServiceRole` and `ServiceRoleBinding` resources created.
