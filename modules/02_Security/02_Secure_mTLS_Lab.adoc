...
+
----
$ oc get secret istio.incident-service -o jsonpath={.data.cert-chain\\.pem} -n $ER_DEMO_NS | base64 --decode 
----
+
.Sample Output
----
...
IMPORTANT: Check if Citadel certificate lifepsan is configurable.
...
+
----
$ oc edit dc $ERDEMO_USER-incident-service -o yaml -n $ER_DEMO_NS
----
+
...
+
----
$ oc patch dc $ERDEMO_USER-incident-service --type='json' -p '[{"op": "remove", "path": "/spec/template/spec/containers/0/livenessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/livenessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/actuator/health"]}, "initialDelaySeconds": 30, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}, {"op": "remove", "path": "/spec/template/spec/containers/0/readinessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/readinessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/actuator/health"]}, "initialDelaySeconds": 30, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}]' -n $ER_DEMO_NS
----
...
+
----
$ oc patch dc $ERDEMO_USER-incident-service --type='json' -p "[{\"op\": \"add\", \"path\": \"/spec/template/metadata\", \"value\": {\"annotations\":{\"sidecar.istio.io/inject\": \"true\"}, \"labels\":{\"app\":\"$ERDEMO_USER-incident-service\",\"group\":\"erd-services\"}}}]" -n $ER_DEMO_NS
----
+
...
spec:
  host: $ERDEMO_USER-incident-service.$ER_DEMO_NS.svc.cluster.local
  trafficPolicy:
    tls:
      mode: ISTIO_MUTUAL
...
spec:
  ...
  gateways:
  - erd-wildcard-gateway.$RHSM_CONTROL_PLANE_NS.svc.cluster.local
  http:
  - match:
    - uri:
        prefix: /incidents
...
+
----
$ oc delete route $ERDEMO_USER-incident-service -n $ER_DEMO_NS
----
...
$ istioctl -n $RHSM_CONTROL_PLANE_NS -i $RHSM_CONTROL_PLANE_NS authn tls-check ${ISTIO_INGRESSGATEWAY_POD} $ERDEMO_USER-incident-service.$ER_DEMO_NS.svc.cluster.local
----
+
.Sample Output
----
...
In a browser window, navigate to the Istio Grafana instance (https://grafana-$RHSM_CONTROL_PLANE.apps.$SUBDOMAIN_BASE) and log in with your admin OpenShift credentials. Locate the _Istio Workload Dashboard_. Select the `Incident Service` workload in the `emergency-response-demo` namespace. Scroll down to the _Inbound Workloads_ section. +
...
+
----
$ oc patch dc $ERDEMO_USER-responder-service --type='json' -p '[{"op": "remove", "path": "/spec/template/spec/containers/0/livenessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/livenessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/actuator/health"]},"initialDelaySeconds": 30, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}, {"op": "remove", "path": "/spec/template/spec/containers/0/readinessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/readinessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/actuator/health"]},"initialDelaySeconds": 30, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}]' -n $ER_DEMO_NS
----

. Annotate the Responder Service pods with the `sidecar.istio.io/inject: "true"` annotation.
+
----
$ oc patch dc $ERDEMO_USER-responder-service --type='json' -p "[{\"op\": \"add\", \"path\": \"/spec/template/metadata\", \"value\": {\"annotations\":{\"sidecar.istio.io/inject\": \"true\"}, \"labels\":{\"app\":\"$ERDEMO_USER-responder-service\",\"group\":\"erd-services\"}}}]" -n $ER_DEMO_NS
----
...
+
----
$ oc create -f responder-service-policy.yml -n $ER_DEMO_NS
----
...
spec:
  host: $ERDEMO_USER-responder-service.$ER_DEMO_NS.svc.cluster.local
  trafficPolicy:
    tls:
      mode: ISTIO_MUTUAL
...
+
----
$ oc create -f responder-service-mtls-destinationrule.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f responder-service-virtualservice.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f responder-service-gateway.yml -n $RHSM_CONTROL_PLANE_NS
----
. Delete the existing Responder Service route
+
----
$ oc delete route $ERDEMO_USER-responder-service -n $ER_DEMO_NS
----
...
+
----
$ oc patch dc $ERDEMO_USER-disaster-simulator --type='json' -p '[{"op": "remove", "path": "/spec/template/spec/containers/0/livenessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/livenessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080"]}, "initialDelaySeconds": 10, "timeoutSeconds": 1, "periodSeconds": 10, "successThreshold": 1, "failureThreshold": 3}}, {"op": "remove", "path": "/spec/template/spec/containers/0/readinessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/readinessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080"]},"initialDelaySeconds": 10, "timeoutSeconds": 1, "periodSeconds": 10, "successThreshold": 1, "failureThreshold": 3}}]' -n $ER_DEMO_NS
----
. Annotate the Disaster Simulator pods with the `sidecar.istio.io/inject: "true"` annotation.
+
----
$ oc patch dc $ERDEMO_USER-disaster-simulator --type='json' -p "[{\"op\": \"add\", \"path\": \"/spec/template/metadata\", \"value\": {\"annotations\":{\"sidecar.istio.io/inject\": \"true\"}, \"labels\":{\"app\":\"$ERDEMO_USER-disaster-simulator\",\"group\":\"erd-services\"}}}]" -n $ER_DEMO_NS
----
...
+
----
$ oc create -f disaster-simulator-policy.yml -n $ER_DEMO_NS
----
...
spec:
  host: $ERDEMO_USER-disaster-simulator.$ER_DEMO_NS.svc.cluster.local
  trafficPolicy:
    tls:
      mode: ISTIO_MUTUAL
...
+
----
$ oc create -f disaster-simulator-mtls-destinationrule.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f disaster-simulator-virtualservice.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f disaster-simulator-gateway.yml -n $RHSM_CONTROL_PLANE_NS
----

. Delete the existing Disaster Simulator route
+
----
$ oc delete route $ERDEMO_USER-disaster-simulator -n $ER_DEMO_NS
----
...
+
----
$ oc edit dc $ERDEMO_USER-incident-priority-service -o yaml -n $ER_DEMO_NS
----
+
Replace the existing liveness and readiness probes with command based probes:
+
...
+
----
$ oc patch dc $ERDEMO_USER-incident-priority-service --type='json' -p '[{"op": "remove", "path": "/spec/template/spec/containers/0/livenessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/livenessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/health"]}, "initialDelaySeconds": 30, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}, {"op": "remove", "path": "/spec/template/spec/containers/0/readinessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/readinessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/health"]},"initialDelaySeconds": 10, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}]' -n $ER_DEMO_NS
----
. Annotate the Incident Priority Service pods with the `sidecar.istio.io/inject: "true"` annotation.
+
----
$ oc patch dc $ERDEMO_USER-incident-priority-service --type='json' -p "[{\"op\": \"add\", \"path\": \"/spec/template/metadata\", \"value\": {\"annotations\":{\"sidecar.istio.io/inject\": \"true\"}, \"labels\":{\"app\":\"$ERDEMO_USER-incident-priority-service\",\"group\":\"erd-services\"}}}]" -n $ER_DEMO_NS
----
...
+
----
$ oc create -f incident-priority-service-policy.yml -n $ER_DEMO_NS
----
...
spec:
  host: $ERDEMO_USER-incident-priority-service.$ER_DEMO_NS.svc.cluster.local
  trafficPolicy:
    tls:
      mode: ISTIO_MUTUAL
...
+
----
$ oc create -f incident-priority-service-mtls-destinationrule.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f incident-priority-service-virtualservice.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f incident-priority-service-gateway.yml -n $RHSM_CONTROL_PLANE_NS
----

. Delete the existing Incident Priority Service route
+
----
$ oc delete route $ERDEMO_USER-incident-priority-service -n $ER_DEMO_NS
----
...
+
----
$ oc patch dc $ERDEMO_USER-process-service --type='json' -p '[{"op": "remove", "path": "/spec/template/spec/containers/0/livenessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/livenessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/acuator/health"]},"initialDelaySeconds": 60, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}, {"op": "remove", "path": "/spec/template/spec/containers/0/readinessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/readinessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/actuator/health"]},"initialDelaySeconds": 45, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}]' -n $ER_DEMO_NS
----
. Annotate the Process Service pods with the `sidecar.istio.io/inject: "true"` annotation.
+
----
$ oc patch dc $ERDEMO_USER-process-service --type='json' -p "[{\"op\": \"add\", \"path\": \"/spec/template/metadata\", \"value\": {\"annotations\":{\"sidecar.istio.io/inject\": \"true\"}, \"labels\":{\"app\":\"$ERDEMO_USER-process-service\",\"group\":\"erd-services\"}}}]" -n $ER_DEMO_NS
----
...
+
----
$ oc create -f process-service-policy.yml -n $ER_DEMO_NS
----
...
spec:
  host: $ERDEMO_USER-process-service.$ER_DEMO_NS.svc.cluster.local
  trafficPolicy:
    tls:
      mode: ISTIO_MUTUAL
...
+
----
$ oc create -f process-service-mtls-destinationrule.yml -n $ER_DEMO_NS
----
...
+
----
$ oc patch dc $ERDEMO_USER-mission-service --type='json' -p '[{"op": "remove", "path": "/spec/template/spec/containers/0/livenessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/livenessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080"]},"initialDelaySeconds": 10, "timeoutSeconds": 1, "periodSeconds": 10, "successThreshold": 1, "failureThreshold": 3}}, {"op": "remove", "path": "/spec/template/spec/containers/0/readinessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/readinessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080"]},"initialDelaySeconds": 10, "timeoutSeconds": 1, "periodSeconds": 10, "successThreshold": 1, "failureThreshold": 3}}]' -n $ER_DEMO_NS
----
. Annotate the Mission Service pods with the `sidecar.istio.io/inject: "true"` annotation.
+
----
$ oc patch dc $ERDEMO_USER-mission-service --type='json' -p "[{\"op\": \"add\", \"path\": \"/spec/template/metadata\", \"value\": {\"annotations\":{\"sidecar.istio.io/inject\": \"true\"}, \"labels\":{\"app\":\"$ERDEMO_USER-mission-service\",\"group\":\"erd-services\"}}}]" -n $ER_DEMO_NS
----
...
+
----
$ oc create -f mission-service-policy.yml -n $ER_DEMO_NS
----
...
spec:
  host: $ERDEMO_USER-mission-service.$ER_DEMO_NS.svc.cluster.local
  trafficPolicy:
    tls:
      mode: ISTIO_MUTUAL
...
+
----
$ oc create -f mission-service-mtls-destinationrule.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f mission-service-virtualservice.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f mission-service-gateway.yml -n $RHSM_CONTROL_PLANE_NS
----

. Delete the existing Mission Service route:
+
----
$ oc delete route $ERDEMO_USER-mission-service -n $ER_DEMO_NS
----
...
+
----
$ oc patch dc $ERDEMO_USER-responder-simulator --type='json' -p '[{"op": "remove", "path": "/spec/template/spec/containers/0/livenessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/livenessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/metrics"]},"initialDelaySeconds": 10, "timeoutSeconds": 1, "periodSeconds": 10, "successThreshold": 1, "failureThreshold": 3}}, {"op": "remove", "path": "/spec/template/spec/containers/0/readinessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/readinessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/metrics"]},"initialDelaySeconds": 10, "timeoutSeconds": 1, "periodSeconds": 10, "successThreshold": 1, "failureThreshold": 3}}]' -n $ER_DEMO_NS
----

. Annotate the Responder Simulator pods with the `sidecar.istio.io/inject: "true"` annotation.
+
----
$ oc patch dc $ERDEMO_USER-responder-simulator --type='json' -p "[{\"op\": \"add\", \"path\": \"/spec/template/metadata\", \"value\": {\"annotations\":{\"sidecar.istio.io/inject\": \"true\"}, \"labels\":{\"app\":\"$ERDEMO_USER-responder-simulator\",\"group\":\"erd-services\"}}}]" -n $ER_DEMO_NS
----
...
+
----
$ oc create -f responder-simulator-policy.yml -n $ER_DEMO_NS
----
...
spec:
  host: $ERDEMO_USER-responder-simulator.$ER_DEMO_NS.svc.cluster.local
  trafficPolicy:
    tls:
      mode: ISTIO_MUTUAL
...
+
----
$ oc create -f responder-simulator-mtls-destinationrule.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f responder-simulator-virtualservice.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f responder-simulator-gateway.yml -n $RHSM_CONTROL_PLANE_NS
----

. Delete the existing Responder Simulator route
+
----
$ oc delete route $ERDEMO_USER-responder-simulator -n $ER_DEMO_NS
----
...
+
----
$ oc patch dc $ERDEMO_USER-process-viewer --type='json' -p '[{"op": "remove", "path": "/spec/template/spec/containers/0/livenessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/livenessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/health"]},"initialDelaySeconds": 15, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}, {"op": "remove", "path": "/spec/template/spec/containers/0/readinessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/readinessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/health"]},"initialDelaySeconds": 5, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}]' -n $ER_DEMO_NS
----

. Annotate the Process Viewer pods with the `sidecar.istio.io/inject: "true"` annotation.
+
----
$ oc patch dc $ERDEMO_USER-process-viewer --type='json' -p "[{\"op\": \"add\", \"path\": \"/spec/template/metadata\", \"value\": {\"annotations\":{\"sidecar.istio.io/inject\": \"true\"}, \"labels\":{\"app\":\"$ERDEMO_USER-process-viewer\"}}}]" -n $ER_DEMO_NS
----
...
+
----
$ oc create -f process-viewer-policy.yml -n $ER_DEMO_NS
----
...
spec:
  host: $ERDEMO_USER-process-viewer.$ER_DEMO_NS.svc.cluster.local
  trafficPolicy:
    tls:
      mode: ISTIO_MUTUAL
...
+
----
$ oc create -f process-viewer-mtls-destinationrule.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f process-viewer-virtualservice.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f process-viewer-gateway.yml -n $RHSM_CONTROL_PLANE_NS
----

. Delete the existing Process Viewer route
+
----
$ oc delete route $ERDEMO_USER-process-viewer -n $ER_DEMO_NS
----
...
+
----
$ oc patch dc $ERDEMO_USER-emergency-console --type='json' -p '[{"op": "remove", "path": "/spec/template/spec/containers/0/livenessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/livenessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080"]}, "initialDelaySeconds": 30, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}, {"op": "remove", "path": "/spec/template/spec/containers/0/readinessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/readinessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080"]},"initialDelaySeconds": 30, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}]' -n $ER_DEMO_NS
----

. Annotate the Emergency Console pods with the `sidecar.istio.io/inject: "true"` annotation.
+
----
$ oc patch dc $ERDEMO_USER-emergency-console --type='json' -p "[{\"op\": \"add\", \"path\": \"/spec/template/metadata\", \"value\": {\"annotations\":{\"sidecar.istio.io/inject\": \"true\"}, \"labels\":{\"app\":\"$ERDEMO_USER-emergency-console\"}}}]" -n $ER_DEMO_NS
----
...
+
----
$ oc create -f emergency-console-policy.yml -n $ER_DEMO_NS
----
...
spec:
  host: $ERDEMO_USER-emergency-console.$ER_DEMO_NS.svc.cluster.local
  trafficPolicy:
    tls:
      mode: ISTIO_MUTUAL
...
+
----
$ oc create -f emergency-console-mtls-destinationrule.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f emergency-console-virtualservice.yml -n $ER_DEMO_NS
----
...
+
----
$ oc create -f emergency-console-gateway.yml -n $RHSM_CONTROL_PLANE_NS
----

. Delete the existing Emergency Console route
+
----
$ oc delete route $ERDEMO_USER-emergency-console -n $ER_DEMO_NS
----
...
+
----
$ oc patch dc postgresql --type='json' -p "[{\"op\": \"add\", \"path\": \"/spec/template/metadata\", \"value\": {\"annotations\":{\"sidecar.istio.io/inject\": \"true\"}, \"labels\":{\"app\":\"postgresql\", \"name\":\"postgresql\"}}}]" -n $ER_DEMO_NS
----
...
+
----
$ oc create -f postgresql-policy.yml -n $ER_DEMO_NS
----
...
spec:
  host: postgresql.$ER_DEMO_NS.svc.cluster.local
  trafficPolicy:
    tls:
      mode: ISTIO_MUTUAL
...
+
----
$ oc create -f postgresql-mtls-destinationrule.yml -n $ER_DEMO_NS
----
...
+
----
$ oc patch dc $ERDEMO_USER-process-service-postgresql --type='json' -p "[{\"op\": \"add\", \"path\": \"/spec/template/metadata\", \"value\": {\"annotations\":{\"sidecar.istio.io/inject\": \"true\"}, \"labels\":{\"app\":\"$ERDEMO_USER-process-service\", \"name\":\"$ERDEMO_USER-process-service-postgresql\"}}}]" -n $ER_DEMO_NS
----
...
spec:
  host: process-service-postgresql.$ER_DEMO_NS.svc.cluster.local
  trafficPolicy:
    tls:
      mode: ISTIO_MUTUAL
...
+
----
$ oc patch policy incident-service-mtls --type='json' -p '[{"op":"replace","path":"/spec/peers/0/mtls/mode", "value": "STRICT"}]' -n $ER_DEMO_NS
----
...
spec:
  ...
  inclusion:
    services:
      - incident-service.$ER_DEMO_NS.svc.cluster.local
...
spec:
  rules:
    - services: ["$ERDEMO_USER-incident-service.$ER_DEMO_NS.svc.cluster.local"]
      methods: ["*"]
...
spec:
  subjects:
    - user: "cluster.local/ns/$ER_DEMO_NS/sa/istio-ingressgateway-service-account"
  roleRef:
    kind: ServiceRole
    name: "incident-service-internal"
" > srb-incident-service-ingress.yml
