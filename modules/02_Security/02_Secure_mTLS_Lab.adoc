...
[WARNING]
====
In the latest released version of the OpenShift Service Mesh operator, mesh wide rewrite of HTTP-based health checks does not longer work for Service Mesh v1.
