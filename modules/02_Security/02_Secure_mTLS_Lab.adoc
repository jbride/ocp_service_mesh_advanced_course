...
full-install   11/11   ComponentsReady    [default]  1.1.10    26h
----

. Review the `ServiceMeshControlPlane` custom resource:
+
----
$ oc get smcp.v1.maistra.io full-install -o yaml -n $SM_CP_NS
----
+
----
...
metadata:
  annotations:
    kubectl.kubernetes.io/last-applied-configuration: |
      {"apiVersion":"maistra.io/v1","kind":"ServiceMeshControlPlane","metadata":{"annotations":{},"name":"full-install","namespace":"admin1-istio-system"},"spec":{"istio":{"gateways":{"istio-egressgateway":{"autoscaleEnabled":false},"istio-ingressgateway":{"autoscaleEnabled":false,"ior_enabled":false}},"global":{"disablePolicyChecks":true,"mtls":{"auto":false,"enabled":false},"proxy":{"resources":{"limits":{"cpu":"500m","memory":"128Mi"},"requests":{"cpu":"100m","memory":"128Mi"}}}},"kiali":{"dashboard":{"passphrase":"redhat","user":"admin"}},"mixer":{"policy":{"autoscaleEnabled":false},"telemetry":{"autoscaleEnabled":false,"resources":{"limits":{"cpu":"500m","memory":"4G"},"requests":{"cpu":"100m","memory":"1G"}}}},"pilot":{"autoscaleEnabled":false,"traceSampling":100},"tracing":{"enabled":true}},"threeScale":{"enabled":false},"version":"v1.1"}}
  creationTimestamp: "2020-11-11T13:54:36Z"
  finalizers:
  ...
  resourceVersion: "237122"
  selfLink: /apis/maistra.io/v1/namespaces/admin1-istio-system/servicemeshcontrolplanes/full-install
  uid: 0a839c95-6e9a-465c-9a7f-2e59654ab5b4
spec:
  istio:
    gateways:
      istio-egressgateway:
...
metadata:
  annotations:
    kubectl.kubernetes.io/last-applied-configuration: |
      [...]
    maistra.io/mesh-generation: 2.0.0-13.el8-1
  creationTimestamp: "2020-11-11T13:54:40Z"
  generation: 1
  labels:
    app: security
    app.kubernetes.io/component: security
    app.kubernetes.io/instance: admin1-istio-system
    app.kubernetes.io/managed-by: maistra-istio-operator
    app.kubernetes.io/name: security
    app.kubernetes.io/part-of: istio
    app.kubernetes.io/version: 2.0.0-13.el8-1
    chart: security
    heritage: Tiller
    maistra-version: 1.1.10
    maistra.io/owner: admin1-istio-system
    release: istio
  managedFields:
    [...]
  name: default
  ...
  - apiVersion: maistra.io/v2
    ...
    name: full-install
    uid: 0a839c95-6e9a-465c-9a7f-2e59654ab5b4
  resourceVersion: "235912"
  selfLink: /apis/authentication.maistra.io/v1/namespaces/admin1-istio-system/servicemeshpolicies/default
  uid: c44d0b5e-6148-41eb-a013-746c26453b24
spec:
  peers:
  - mtls:
      mode: PERMISSIVE
...
[WARNING]
====
In the latest released version of the OpenShift Service Mesh operator, mesh wide rewrite of HTTP-based health checks does not longer work when using Service Mesh v1.
...
+
----
$ oc edit smcp.v1.maistra.io full-install -o yaml -n $SM_CP_NS
----
...
----
$ oc patch dc $ERDEMO_USER-incident-service --type='json' -p '[{"op": "remove", "path": "/spec/template/spec/containers/0/livenessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/livenessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/health/ready"]}, "initialDelaySeconds": 10, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}, {"op": "remove", "path": "/spec/template/spec/containers/0/readinessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/readinessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/health/ready"]}, "initialDelaySeconds": 10, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}]' -n $ERDEMO_NS
----
====
...
----
$ oc patch dc $ERDEMO_USER-responder-service --type='json' -p '[{"op": "remove", "path": "/spec/template/spec/containers/0/livenessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/livenessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/health/live"]},"initialDelaySeconds": 10, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}, {"op": "remove", "path": "/spec/template/spec/containers/0/readinessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/readinessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/health/ready"]},"initialDelaySeconds": 3, "timeoutSeconds": 3, "periodSeconds": 30, "successThreshold": 1, "failureThreshold": 3}}]' -n $ERDEMO_NS
----
====
...
The mission service is not exposed outside of the cluster, so there is no need for a `VirtualService` resource or a route.
...
----
$ oc patch dc $ERDEMO_USER-mission-service --type='json' -p '[{"op": "remove", "path": "/spec/template/spec/containers/0/livenessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/livenessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/health/live"]},"initialDelaySeconds": 10, "timeoutSeconds": 1, "periodSeconds": 10, "successThreshold": 1, "failureThreshold": 3}}, {"op": "remove", "path": "/spec/template/spec/containers/0/readinessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/readinessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/health/ready"]},"initialDelaySeconds": 3, "timeoutSeconds": 1, "periodSeconds": 10, "successThreshold": 1, "failureThreshold": 3}}]' -n $ERDEMO_NS
----
====
...
The responder simulator service is not exposed outside of the cluster, so there is no need for a `VirtualService` resource or a route.
...
----
$ oc patch dc $ERDEMO_USER-responder-simulator --type='json' -p '[{"op": "remove", "path": "/spec/template/spec/containers/0/livenessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/livenessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/health"]},"initialDelaySeconds": 10, "timeoutSeconds": 1, "periodSeconds": 10, "successThreshold": 1, "failureThreshold": 3}}, {"op": "remove", "path": "/spec/template/spec/containers/0/readinessProbe/httpGet"}, {"op": "add", "path": "/spec/template/spec/containers/0/readinessProbe", "value": { "exec": { "command" : ["curl", "http://127.0.0.1:8080/health"]},"initialDelaySeconds": 3, "timeoutSeconds": 1, "periodSeconds": 10, "successThreshold": 1, "failureThreshold": 3}}]' -n $ERDEMO_NS
----
====
...
The process viewer service is not exposed outside of the cluster, so there is no need for a `VirtualService` resource or a route.
