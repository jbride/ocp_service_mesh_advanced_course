...
Later labs show you how API policy management (via 3scale API Management) and service mesh management (via OpenShift Service Mesh) are _complementary_ technologies.
