...
-----
+
This _NetworkPolicy_ allows ingress to all pods specific to this namespace from all other registered _members of the same Red Hat Service Mesh control plane.
...
-----
+
The $ERDEMO_USER is the admin of the $ERDEMO_NS namespace where the Emergency Response application resides.
